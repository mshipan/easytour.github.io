		...
		<div class="container">
			<div class="row">
				<header class="entry-header">
					<h1 class="entry-title">World’s hottest destinations for vegans</h1>
				...
				<div class="img_post"><a href="single.html">
					<img style="width: 100%; height: 550px; margin-top: 10px;  border-radius: 10px;" src="images/blog/86H.jpg" class="wp-post-image" alt=""></a>
				</div>
			<hr>
			<div class="site-main col-sm-12" style="border: 2px;">
