...
session_start();
if(!$_SESSION['user_id']) {
	 header("location:login.php?loginErrMsg=Login First!");
}
$id=$_SESSION['user_id'];
        ...
        <div class="row">
          ...
          <div class="msg_history" style="position: relative;">
            <div class="incoming_msg">
              ...
              <?php 
              $chat=Chat::where('user_1',$id)->value('id');
              // print_r($chat->chatMessages);die;

              $ms=ChatMessage::where('chat_id',$chat)->orderBy('created_at','ASC')->get();
