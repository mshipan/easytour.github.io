			...
			<div class="container">
				...
				<div class="width-logo sm-logo">
					<a href="index.php" title="Travel" rel="home">
						<img src="images/log.png" alt="Logo" width="474" height="130" class="logo_transparent_static">
						<img src="images/log_sticky.png" alt="Sticky logo" width="474" height="130" class="logo_sticky">
					</a>
				</div>
