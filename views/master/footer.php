<div class="wrapper-footer wrapper-footer-newsletter">
				...
				<aside class="col-sm-3 widget_text"><h3 class="widget-title">CONTACT</h3>
					<div class="textwidget">
						<div class="footer-info">
							<p>EasyTour is always open. 24/7 Support
							</p>
							<ul class="contact-info">
								<li><i class="fa fa-map-marker fa-fw"></i> Daffodil International University</li>
								<li><i class="fa fa-phone fa-fw"></i> +880-1622-543390</li>
								<li>
									<i class="fa fa-envelope fa-fw"></i><a href="mailto:hello@siteinfo.com"> info@easytour.com</a>
								</li>
							</ul>
						</div>
					</div>
	...
	<div class="container wrapper-copyright">
		<div class="row">
			<div class="col-sm-6">
				<div><p>Copyright © 2019 EasyTour. All Rights Reserved. DIU</p></div>
			</div>
			<div class="col-sm-6">
