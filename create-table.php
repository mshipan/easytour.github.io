...
// Manager::schema()->dropIfExists('payment');
// Manager::schema()->create('payment', function ($table) {
//     $table->increments('id');
...
Manager::schema()->dropIfExists('confirm_code');
Manager::schema()->create('confirm_code', function ($table) {
    $table->increments('id');
